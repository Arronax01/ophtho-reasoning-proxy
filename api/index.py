...
OPENAI_URL = "https://api.openai.com/v1/responses"  # Responses API
PROXY_TOKEN = os.environ.get("PROXY_TOKEN", "secret")  # token per l'Action Bearer
...
def reason(body: ReasonReq, authorization: str | None = Header(default=None)):
    ...
    data = r.json()
    # estrazione robusta del testo (lo schema può evolvere)
    try:
